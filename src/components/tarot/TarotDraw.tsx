    ...
    return (
        <div className="tarot-wrapper w-full min-h-screen">
            ...
            <div className="deck-select-wrapper mt-8">
                <label htmlFor="deck" className="deck-label text-center">
                    Choose Tarot Deck
                </label>
                <NiceSelectForm
                    options={tarotDecks.map((deck, index) => ({ id: index, option: deck.label, value: deck.value }))}
                    defaultCurrent={0}
                    onChange={(item: any) => {
                        if (item) {
                            setSelectedDeck(item.value);
                        }
                    }}
                    name="deck"
