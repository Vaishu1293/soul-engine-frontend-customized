...
const WeeklyInsights: React.FC<WeeklyInsightsProps> = ({ title }) => {
  useFlashlightAnimation();

  return (
    <div className="about-info-wrapper mb-30">
      <div className="accordion accordion-general" id="weeklyInsights1">
        <div className="accordion-item light-effect">
          <h2 className="accordion-header" id="weeklyAnalyticsHeading1">
            <button
              className="accordion-button"
              type="button"
              data-bs-toggle="collapse"
              data-bs-target="#weeklyAnalyticsPane1"
              aria-expanded="true"
              aria-controls="weeklyAnalyticsPane1"
            >
          ...
          <div
            id="weeklyAnalyticsPane1"
            className="accordion-collapse collapse show"
            aria-labelledby="weeklyAnalyticsHeading1"
            data-bs-parent="#weeklyInsights1"
          >
      ...
      <div className="accordion accordion-general" id="weeklyInsights2">
        <div className="accordion-item light-effect">
          <h2 className="accordion-header" id="weeklyAnalyticsHeading2">
            <button
              className="accordion-button"
              type="button"
              data-bs-toggle="collapse"
              data-bs-target="#weeklyAnalyticsPane2"
              aria-expanded="true"
              aria-controls="weeklyAnalyticsPane2"
            >
              📊 Weekly Analytics (July 27 – Aug 02, 2025)
            </button>
          </h2>
          ...
          <div
            id="weeklyAnalyticsPane2"
            className="accordion-collapse collapse show"
            aria-labelledby="weeklyAnalyticsHeading2"
            data-bs-parent="#weeklyInsights2"
          >
            <div className="accordion-body">
              {/* KPIs / quick badges */}
              <div className="flex flex-wrap gap-2 mb-3">
      ...
      <div className="accordion accordion-general" id="weeklyInsights3">
        <div className="accordion-item light-effect">
          <h2 className="accordion-header" id="weeklyAnalyticsHeading3">
            <button
              className="accordion-button"
              type="button"
              data-bs-toggle="collapse"
              data-bs-target="#weeklyAnalyticsPane3"
              aria-expanded="true"
              aria-controls="weeklyAnalyticsPane3"
            >
              📊 Weekly Analytics (July 27 – Aug 02, 2025)
            </button>
          </h2>
          ...
          <div
            id="weeklyAnalyticsPane3"
            className="accordion-collapse collapse show"
            aria-labelledby="weeklyAnalyticsHeading3"
            data-bs-parent="#weeklyInsights3"
          >
            <div className="accordion-body">
              {/* KPIs / quick badges */}
              <div className="flex flex-wrap gap-2 mb-3">
      ...
      <div className="accordion accordion-general" id="weeklyInsights4">
        <div className="accordion-item light-effect">
          <h2 className="accordion-header" id="weeklyAnalyticsHeading4">
            <button
              className="accordion-button"
              type="button"
              data-bs-toggle="collapse"
              data-bs-target="#weeklyAnalyticsPane4"
              aria-expanded="true"
              aria-controls="weeklyAnalyticsPane4"
            >
              📊 Weekly Analytics (July 27 – Aug 02, 2025)
            </button>
          </h2>
          ...
          <div
            id="weeklyAnalyticsPane4"
            className="accordion-collapse collapse show"
            aria-labelledby="weeklyAnalyticsHeading4"
            data-bs-parent="#weeklyInsights4"
          >
            <div className="accordion-body">
              {/* KPIs / quick badges */}
              <div className="flex flex-wrap gap-2 mb-3">
